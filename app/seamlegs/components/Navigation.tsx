...
const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <div className="hidden md:block sticky top-32 w-[200px] md:w-[250px]">
      ...
      <a href="https://github.com/kl527/emotion_robot" className="mt-16 w-full bg-[#007089] md:h-[38px] transition duration-500 group transition-colors duration-500 ease-in-out flex h-10 items-center justify-center gap-2.5 py-[3px] left-0 border-4 border-solid border-[#007089]">
        <div className='flex items-center justify-center gap-2'>
          <p className='text-center md:text-[18px] font-bold text-white text-sm transition-colors duration-300 ease-in-out'>See the code</p>
          <div className='flex items-center'>
