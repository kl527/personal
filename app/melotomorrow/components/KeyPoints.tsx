...
export default function KeyPoints() {
    ...
    return (
        <div className="w-[237px] md:w-[646px] lg:w-[800px]">
            <h1 className="mb-4 text-black text-lg mt-8 md:text-[21px] tracking-[0] leading-[normal]">Key Points</h1>
            <div className=''>
                ...
                <p className="mb-3 font-normal text-black md:text-[20px] text-base tracking-[0] leading-7">
                    Individuals with ASD often experience <em ref={ref1} className={`highlightKey ${isInViewport1 ? 'shown' : ''}`}>visual hypersensitivity, making them extremely sensitive to certain colors and patterns.</em> This results in discomfort and challenges in wearing conventional clothing, leading to a reliance on a limited selection of visually comfortable garments.
                </p>
            ...
            <div className=''>
                ...
                <p className="mb-3 font-normal text-black md:text-[20px] text-base tracking-[0] leading-7">
                    Many existing clothing lines for individuals with ASD focus on younger children and <em ref={ref2} className={`highlightKey ${isInViewport2 ? 'shown' : ''}`}>lack options for teenagers and adults.</em></p>
                <h1 className='font-bold text-lg md:text-[18px] tracking-[0] leading-[normal]'>Things I learned:</h1>
                <ul className="mb-7">
                    <li className="italic ml-4 list-disc font-normal text-black md:text-[20px] text-base tracking-[0] leading-7">
