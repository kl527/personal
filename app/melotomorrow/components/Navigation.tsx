...
interface NavigationProps {
  sections: { id: string; title: string; subsections?: { id: string; title: string }[] }[]
  activeSection: string
  activeSubsection: string
  onSectionClick: (sectionId: string) => void
}

export default function Navigation({ sections, activeSection, activeSubsection, onSectionClick }: NavigationProps) {
  return (
