            ...
            <ul>
                <li className="ml-4 list-disc font-normal mb-5 text-black md:text-[20px] text-base tracking-[0]">
                    <em ref={ref1} className={`highlight ${isInViewport1 ? 'shown' : ''}`}>
                        35% of people with autism report hyper reactivity to tactile sensitivity </em><a className="underline underline-offset-2" href="https://pubmed.ncbi.nlm.nih.gov/27475418/">(Green et al. 2016)</a>
                </li>
                <li className="ml-4 list-disc font-normal mb-5 text-black md:text-[20px] text-base tracking-[0]">
                    People with autism spectrum disorder (ASD) reported <em ref={ref2} className={`highlight ${isInViewport2 ? 'shown' : ''}`}>
                        highly negatively in regards to fabric labels
