...
export default function HiFis() {
    ...
    return (
        <div className="w-full md:w-[646px] lg:w-[800px]">
            ...
            <p className="font-normal mb-1 text-black md:text-[20px] text-base tracking-[0] leading-7">Based on the mid-fidelity wireframes, we developed high-fidelity designs to present to users. <em ref={ref1} className={`highlight ${isInViewport1 ? 'shown' : ''}`}>We created multiple iterations based on the feedback we received.</em> Here are some of the feedback notes and the corresponding iterations we created:</p>
