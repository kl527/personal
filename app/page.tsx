export const Left = (): JSX.Element => {
  return (
    <div>
      <button className="group md:border-[6px] mb-[170px] md:mb-[180px] transition-colors duration-300 ease-in-out hover:bg-black flex w-[45px] md:w-[60px] md:h-[86px] h-16 items-center justify-center border-4 border-solid border-black">
...
export const Header = (): JSX.Element => {
  return (
    <div className="w-[237px] md:w-[646px] mb-8 md:mb-12">
      ...
      <div className="md:w-[646px] w-[237px] md:h-[8px] h-[7px] bg-black" />
    </div>
  );
};
...
export const Project1 = (): JSX.Element => {
  return (
    <div className="w-[237px] md:w-[646px] md:flex md:gap-5 md:mb-5">
      <div className="w-[237px] md:w-[100%] md:h-[423px] h-[155px] bg-[#d9d9d9]" />
      <div className="md:w-[500px]">
        ...
        <p className="font-normal mb-4 text-black md:text-[20px] text-base tracking-[0] leading-[normal] ">
          ...
          <span className="font-normal"> for people with tactile hypersensitivity.</span>
        </p>
        <button className="md:w-[155px] md:h-[40px] transition duration-500 hover:-translate-y-1 group transition-colors duration-500 ease-in-out hover:bg-black mb-7 flex w-[116px] h-9 items-center gap-2.5 pl-[9px] pr-[15px] py-[3px] left-0 border-4 border-solid border-black">
...
export default function Home() {
  return (
    <main className="flex flex-row place-content-center mt-10 md:mt-[60px]">
