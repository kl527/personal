        ...
        <div className='mb-7 md:mb-12'>
            ...
            <div className="md:w-[646px] w-full lg:w-[800px]">
                ...
                <div className='flex gap-3'>
                    <Link href="/about" className="md:w-[135px] md:h-[40px] transition duration-500 group transition-colors duration-500 ease-in-out hover:bg-black flex w-[105px] h-9 items-center gap-2.5 pl-[9px] pr-[13px] py-[3px] left-0 border-4 border-solid border-black">
